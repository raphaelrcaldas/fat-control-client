...
export const grupoPgRecords: GrupoPgPublic[] = [
   ...
   },
   {
      ...
      pg_short: "s1",
      pg_mid: "S1",
      pg_long: "soldado primeira classe",
      circulo: "praca",
   },
   {
      id: 16,
      ...
      pg_short: "s2",
      pg_mid: "S2",
      pg_long: "soldado segunda classe",
      circulo: "praca",
   },
];
...
export const GRUPO_PG_DESCRICAO: Record<number, string> = {
   1: "Ten Brig, Maj Brig, Brig",
   2: "Cel, Ten Cel, Maj",
   3: "Cap, 1T, 2T, SO, 1S, 2S, 3S",
   4: "Cb, S1, S2",
};
