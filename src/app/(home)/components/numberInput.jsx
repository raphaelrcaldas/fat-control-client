            ...
            slotProps={{
                root: (ownerState) => {
                    ...
                    return {
                        ...resolvedSlotProps,
                        className: clsx(
                            'grid h-14 w-20 grid-cols-[1fr_4px] grid-rows-2 overflow-hidden font-sans rounded-lg text-slate-900 dark:text-slate-300 border border-solid  bg-white dark:bg-slate-900  hover:border-violet-400 dark:hover:border-violet-400 focus-visible:outline-0 p-1',
                            ownerState.focused
                ...
                input: (ownerState) => {
                    ...
                    return {
                        ...resolvedSlotProps,
                        className: clsx(
                            'col-start-1 w-10 col-end-2 row-start-1 row-end-3 text-base font-sans leading-normal text-slate-900 bg-inherit border-0 rounded-[inherit] dark:text-slate-300 px-3 py-2 outline-0 focus-visible:outline-0 focus-visible:outline-none',
                            resolvedSlotProps?.className,
                        ),
                    };
                },
