      ...
      <div className="mb-8 grid grid-cols-1 gap-2 md:grid-cols-3">
         {actions.map((action) => {
            ...
            return (
               ...
               >
                  <div className="absolute inset-0 bg-linear-to-br from-transparent via-transparent to-gray-50/50 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
