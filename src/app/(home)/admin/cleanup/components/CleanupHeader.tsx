...
export function CleanupHeader({ isFetching, onRefresh }: CleanupHeaderProps) {
   return (
      <header className="relative overflow-hidden rounded border border-slate-200 bg-white px-5 py-4 shadow-sm sm:px-6 sm:py-5">
         {/* Espinha neutra — escopo de admin de sistema. O vermelho desta tela
             fica para o que é de fato perigo: contagem de órfãos, aviso e
