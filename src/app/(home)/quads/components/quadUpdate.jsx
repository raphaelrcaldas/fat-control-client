...
export function QuadUpdateModal({ quad, updateQuadsTrip, quadsAllUpdate, tridId }) {
    ...
    const handleDelete = async () => {
        const delQuad = window.confirm('Deseja realmente deletar este quadrinho?');
        if (delQuad) {
                ...
                <Modal show={isOpen} onClose={() => setIsOpen(false)} size="sm">
                    ...
                    <Modal.Body>
                        <form onSubmit={handleSubmit}>
                            <h3 className='text-center font-semibold'>ID: {quad.id}</h3>
                            <h3 className='text-center font-semibold mt-4'>{quad.type}</h3>
                            <div className="grid justify-center mt-6 text-center gap-4">
                                    ...
                                    <div className="w-60 grid justify-center bg-gray-50 py-4 rounded-lg shadow-md">
                                        <div className="flex gap-4 items-center">
                                            <div>
                                                <TextInput
                                                    value={quadValue}
                                                    onChange={(e) => setQuadValue(e.target.value)}
                                ...
                                <div className='flex justify-center gap-2 mt-6'>
                                    ...
                                    <Button onClick={handleDelete} color='failure'>Deletar</Button>
