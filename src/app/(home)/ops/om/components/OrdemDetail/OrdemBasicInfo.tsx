      ...
      <div className="grid grid-cols-2 gap-4 md:flex">
         ...
         <div className="col-span-2 md:flex-1">
            ...
            <input
               ...
               maxLength={100}
               className="focus:border-primary-400 focus:ring-primary-400 w-full rounded border-2 border-gray-200 bg-white px-3 py-2.5 text-gray-900 uppercase transition-all placeholder:text-gray-400 focus:ring-2 disabled:cursor-not-allowed disabled:opacity-50"
            />
