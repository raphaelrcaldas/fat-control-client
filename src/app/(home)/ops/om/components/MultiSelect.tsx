   ...
   return (
      <div className={`relative ${className}`} ref={containerRef}>
         <button
            ...
            className={`flex w-full items-center justify-between gap-2 rounded-lg border bg-gray-50 px-4 py-2.5 text-sm transition-all duration-200 focus:border-transparent focus:ring-2 focus:ring-red-500 focus:outline-none ${
               selected.length > 0
