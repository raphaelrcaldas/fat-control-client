...
export default function IndispPage() {
   ...
   return (
      <div className="flex h-full flex-col overflow-hidden">
         <div className="mb-2 flex shrink-0 flex-col items-center gap-3 rounded-lg border border-gray-200 bg-lienar-to-r from-gray-50 to-white px-4 py-3 shadow-sm md:flex-row md:justify-between">
