/**
 * Skeleton da casca da página de detalhe do tripulante. Espelha o hero, a
 * barra de abas e a seção de dados para zero layout-shift na carga.
 */
...
/** Espelha a seção "Dados do Tripulante": 5 campos editáveis. */
