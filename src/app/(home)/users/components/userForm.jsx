                            ...
                            <div className="space-y-2 text-center text-base">
                                <div className="flex justify-between">
                                    <div className="px-2">
                                        ...
                                        <Select defaultValue="" {...register("p_g", { required: true })} disabled={readOnly ? true : false}>
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <div className="px-2 w-48">
                                        ...
                                        <Select defaultValue="" {...register("unidade", { required: true })} disabled={readOnly ? true : false}>
                                            <option value="" disabled></option>
