...
import { useSearchParamsUpdater, getStringParam } from "@/hooks/useSearchParamsState";
   ...
   return (
      <div className="flex flex-col h-full bg-gray-50">
         <div className="mx-auto w-full p-1">
            ...
            <div className="mb-4 bg-white border border-gray-200 rounded-xl shadow-sm p-1 flex">
               <button
                  onClick={() => handleTabChange("registros")}
                  className={`flex-1 flex items-center justify-center gap-2 py-2.5 text-sm font-semibold rounded-lg transition-all ${
                     activeTabIndex === 0
                        ? "bg-red-50 text-red-700 shadow-sm ring-1 ring-inset ring-red-100"
